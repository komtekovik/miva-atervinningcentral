...
export const allTrashItems: TrashItem[] = [
    ...
    { name: 'Gosedjur', targetId: 'energiatervinning', icon: '🧸', category: 'Energiåtervinning' },
    { name: 'Trasig boll', targetId: 'energiatervinning', icon: '⚽', category: 'Energiåtervinning' },
    { name: 'Paraply', targetId: 'energiatervinning', icon: '☂️', category: 'Energiåtervinning' },
    { name: 'Ryggsäck', targetId: 'energiatervinning', icon: '🎒', category: 'Energiåtervinning' },
    { name: 'Leksak', targetId: 'energiatervinning', icon: '🪀', category: 'Energiåtervinning' },
    { name: 'Madrass', targetId: 'energiatervinning', icon: '🛏️', category: 'Energiåtervinning' },
    { name: 'Matta', targetId: 'energiatervinning', icon: '🧶', category: 'Energiåtervinning' },

    { name: 'Trasig cykel', targetId: 'metall', icon: '🚲', category: 'Metall' },
    { name: 'Stekpanna', targetId: 'metall', icon: '🍳', category: 'Metall' },
    { name: 'Trasig kastrull', targetId: 'metall', icon: '🍲', category: 'Metall' },
    { name: 'Hammare', targetId: 'metall', icon: '🔨', category: 'Metall' },
    { name: 'Skruv', targetId: 'metall', icon: '🔩', category: 'Metall' },
    { name: 'Yxa', targetId: 'metall', icon: '🪓', category: 'Metall' },
    ...
    { name: 'Gräs', targetId: 'gras', icon: '🌱', category: 'Gräs & Löv' },
    { name: 'Löv', targetId: 'gras', icon: '🍂', category: 'Gräs & Löv' },
    { name: 'Blomma', targetId: 'gras', icon: '🥀', category: 'Gräs & Löv' },
